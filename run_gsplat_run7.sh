...
if [ "$#" -ne 3 ]; then
    ...
    echo "Usage: run_gsplat_run6.sh <dress_name> <data_factor> <run_grounding_mask=true>"
    exit 1
fi
...
run 7 loss: ssim+L1, bbox mask, test_every 8, data_factor $1, ssim_lambda 0.2 , sh_degree 3, steps_scaler 1 PNG
EOL
...
echo "RESULTS AT $output_folder/run_7"
